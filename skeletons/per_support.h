 ...
 */
size_t uper_get_length(asn_per_data_t *pd, int effective_bound_bits,
                        size_t lower_bound, int *repeat);

/*
 * Get the normally small length "n".
 */
size_t uper_get_nslength(asn_per_data_t *pd);

/*
 * Get the normally small non-negative whole number.
 */
size_t uper_get_nsnnwn(asn_per_data_t *pd);
 ...
 */
size_t uper_put_length(asn_per_outp_t *po, size_t whole_length,
                        int *opt_need_eom);
