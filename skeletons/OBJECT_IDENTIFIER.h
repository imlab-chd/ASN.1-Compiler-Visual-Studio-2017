 ...
 * 		size_t count;	// Real number of arcs.
 * 		int i;
 *
 ...
 */
size_t OBJECT_IDENTIFIER_get_arcs(const OBJECT_IDENTIFIER_t *oid,
 ...
 */
size_t OBJECT_IDENTIFIER_parse_arcs(const char *oid_text,
                                     size_t oid_txt_length,
 ...
 */
size_t OBJECT_IDENTIFIER_get_single_arc(const uint8_t *arcbuf,
                                         size_t arcbuf_len,
 ...
 */
size_t OBJECT_IDENTIFIER_set_single_arc(uint8_t *arcbuf, size_t arcbuf_len,
