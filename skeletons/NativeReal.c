...
static double NativeReal__get_double(const asn_TYPE_descriptor_t *td,
                                     const void *ptr);
static size_t NativeReal__set(const asn_TYPE_descriptor_t *td, void **sptr,
                               double d);
...
#define NAN (0.0/0.0)
    ...
    size_t float_set_size = NativeReal__float_size(td);
...
static size_t  /* Returns -1 or float size. */
